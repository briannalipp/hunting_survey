...
# -----------------------------------------------------------------------------
# RENAMING VARIABLES + QUESTIONS
# -----------------------------------------------------------------------------
data <- data %>%
  rename(
    
    Q1 = QID7,                        #three words to describe hunters
    Q2 = QID8,                        #three words to describe wildlife advocates
    group_ID = QID9,                  #group ID (hunter or wildlife advocate)
    hunter_strength = QID32_1,        #identity strength (hunters)
    wildlife_strength = QID33_1,      #identity stength (wildlife advocates)
    Q3 = QID75_1,                     #group deprivation scale (GDS) #1
    Q4 = QID76_1,                     #group deprivation scale (GDS) #2
    Q5 = QID77_1,                     #group deprivation scale (GDS) #3
    Q6 = QID78_1,                     #group deprivation scale (GDS) #4
    Q7 = QID79_1,                     #group deprivation scale (GDS) #5
    Q8 = QID56_1,                     #wildlife conspiracy mentality scale (WCMS) #1
    Q9 = QID57_1,                     #wildlife conspiracy mentality scale (WCMS) #2
    Q10 = QID67_1,                    #wildlife conspiracy mentality scale (WCMS) #3
    Q11 = QID68_1,                    #wildlife conspiracy mentality scale (WCMS) #4
    Q12 = QID58_1,                    #wildlife conspiracy mentality scale (WCMS) #5     
    Q13 = QID59_1,                    #wildlife conspiracy mentality scale (WCMS) #6    
    Q14 = QID55_1,                    #wildlife conspiracy mentality scale (WCMS) #7
    Q15 = Colorado_1,                 #state count conspiracy theory (CO)
    Q16 = Idaho_1,                    #state count conspiracy theory (ID)
    Q17 = Michigan_1,                 #state count conspiracy theory (MI)
    Q18 = Minnesota_1,                #state count conspiracy theory (MN)
    Q19 = Montana_1,                  #state count conspiracy theory (MT)
    Q20 = Oregon_1,                   #state count conspiracy theory (OR)
    Q21 = Washington_1,               #state count conspiracy theory (WA)
    Q22 = Wisconsin_1,                #state count conspiracy theory (WI)
    Q23 = Wyoming_1,                  #state count conspiracy theory (WY)
    Q24 = QID40_1,                    #CT #1
    Q25 = QID45_1,                    #CT #2
    Q26 = QID46_1,                    #CT #3
    Q27 = QID71_1,                    #CT #4
    ...
    Q31 = QID86_1,                    #trust #1
    Q32 = QID88_1,                    #trust #2
    Q33 = QID90_1,                    #satisfaction #1
    Q34 = QID91_1,                    #satisfaction #2
    Q35a = QID30_1,                   #media preference (television)
    Q35b = QID30_2,                   #media preference (newspapers/magazines)
    Q35c = QID30_3,                   #media preference (news websites/apps)
    Q35d = QID30_4,                   #media preference (social media)
    Q35e = QID30_5,                   #media preference (word of mouth)
    Q35f = QID30_6,                   #media preference (radio)
    Q35g = QID30_7,                   #media preference (podcast)
    Q35h = QID30_8,                   #media preference (other)
    Q35i = QID30_8_TEXT              #media preference (other, text entry)
  )
